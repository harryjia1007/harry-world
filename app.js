...
const WORKS = [
  ...
  { slot: 'work-taiwan-moto', image: 'images/work-taiwan-moto.svg', year: '2026', kind: tr('資料產品', 'Data Product'), status: tr('正式資料版', 'Live Data'), badge: '#D6FF3F',
    name: tr('臺灣機車拍賣情報', 'Taiwan Moto Auction Intelligence'),
    desc: tr('把政府公開機車拍賣資訊整理成可篩選、可比較、可連回官方公告的正式資料介面。',
             'A live interface for official public motorcycle auctions, with filters, comparisons, and source links.'),
    impact: tr('正式串接臺北惜物網；顯示真實案件、近期官方車牌、價格、照片與拍賣條件。',
               'Live Shwoo integration with real listings, recent official plates, prices, photos, and auction terms.'),
    stack: ['Next.js', 'Python', 'PostgreSQL', 'Supabase'],
    link: 'projects/taiwan-moto-auction/', cta: tr('查看正式案件', 'View live listings') },
